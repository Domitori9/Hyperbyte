...
const products = [
  ...
  { id: 2, name: "Клавиатура Razer", price: 2500, imageUrl: "/images/1.jpg" },
  { id: 3, name: "Клавиатура HyperX", price: 1800, imageUrl: "/images/1.jpg" },
  { id: 4, name: "Клавиатура Logitech", price: 1200, imageUrl: "/images/1.jpg" },
  { id: 5, name: "Клавиатура Razer", price: 2500, imageUrl: "/images/1.jpg" },
  { id: 6, name: "Клавиатура HyperX", price: 1800, imageUrl: "/images/1.jpg" },
];
      ...
      <main className="min-h-screen pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap gap-4 justify-center items-end mb-12 p-8 rounded-2xl bg-gray-800/90 shadow-xl border border-blue-400/30 backdrop-blur-md animate-fade-in">
            ...
            {/* Тип клавиатуры */}
            <div className="flex flex-col">
              <label className="text-white mb-1 font-semibold" htmlFor="type">Тип клавиатуры</label>
