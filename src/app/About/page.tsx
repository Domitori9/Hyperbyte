        ...
        <div className="min-h-screen py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center mb-16">
                    <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl border-2 border-[#2d225a]">
                        <Image
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-[#23204a]/80 p-8 rounded-2xl shadow-lg border border-[#2d225a]">
                ...
                <div className="bg-[#23204a]/80 rounded-2xl shadow-lg p-8 text-center border border-[#2d225a]">
