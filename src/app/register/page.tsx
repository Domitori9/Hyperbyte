    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center to-sky-950 py-12 animate-fade-in">
            <div className="w-full max-w-lg p-10 rounded-[2.5rem] shadow-2xl bg-white/5 backdrop-blur-xl border border-sky-900/40 animate-slide-up relative overflow-hidden">
                ...
                <h1 className="text-3xl font-extrabold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-500 drop-shadow-xl tracking-wide uppercase z-10 relative">Реєстрація</h1>
                ...
                <div className="mt-8 text-center text-sky-200">
                    Вже є акаунт? <a href="/login" className="text-sky-400 underline hover:text-sky-300 transition">Увійти</a>
                </div>
            </div>
        </div>
    );
