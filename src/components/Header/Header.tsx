...
export default function Header() {
    return (
        <header className="relative h-[260px] rounded-b-3xl shadow-xl animate-fade-in bg-[url('/images/2.jpg')] bg-cover bg-center bg-no-repeat">
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div className="flex items-center justify-between px-10 pt-7">
                    ...
                    <div className="hidden md:flex backdrop-blur-3xl bg-white/1 rounded-full shadow-lg px-6 py-2">
